      ...
      <section className="luxury-container py-16 border-t border-gold/10 relative z-10 mb-24 md:mb-32">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          <div className="lg:col-span-7 flex flex-col space-y-6">
            ...
            <div className="space-y-4 text-sm text-alabaster/70 font-sans leading-relaxed">
              <p>
                Building Heels & Glam was about establishing a flagship atelier in Electronic City, Bangalore, to offer personalized cohort mentorship. Under her guidance, the academy has integrated portfolio lookbook photoshoots and formal dining etiquette modules into all signature programs.
              </p>
              <p>
      ...
      <section className="luxury-container py-16 border-t border-gold/10 relative z-10 mb-24 md:mb-32">
        <div className="max-w-3xl mx-auto text-center space-y-8">
          ...
          <div className="space-y-4 text-sm text-alabaster/70 font-sans leading-relaxed max-w-xl mx-auto">
            <p>
              Looking forward, Heels & Glam is set to expand its Electronic City Flagship, integrate advanced biometric movement metrics, and introduce exclusive corporate wellness retreats across India.
            </p>
            <p>
