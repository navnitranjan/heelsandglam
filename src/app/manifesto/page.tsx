...
export default function ManifestoPage() {
  const pillars = [
    ...
    },
    {
      ...
      desc: "We integrate visual style, vocal projection, body kinematics, and personal branding into a singular, undeniable force. Modern femininity is sovereign, strategic, and unconditionally visible.",
