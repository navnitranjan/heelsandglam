...
export default function ManifestoPage() {
  return (
    <div className="min-h-screen bg-obsidian text-pearl py-12 md:py-24 relative overflow-hidden">
      ...
      <div className="absolute top-1/3 left-0 w-[450px] h-[450px] bg-burgundy/10 rounded-full blur-[130px] pointer-events-none" />
      <div className="absolute top-2/3 right-0 w-[450px] h-[450px] bg-rosegold/5 rounded-full blur-[130px] pointer-events-none" />
 
      {/* Editorial Title */}
      <div className="luxury-container flex flex-col items-center text-center mb-16 md:mb-28 animate-fade-in relative z-10">
        <span className="text-[10px] uppercase tracking-[0.35em] text-rosegold font-sans font-semibold mb-4">
          The Declaration
        </span>
        <h1 className="text-4xl md:text-8xl font-serif tracking-luxury text-white uppercase mb-6 leading-none">
          The Heels & Glam<br />
          <span className="text-champagne font-serif">Manifesto</span>
        </h1>
      ...
      <section className="luxury-container grid grid-cols-1 lg:grid-cols-12 gap-16 items-start relative z-10 mb-28">
        ...
        <div className="lg:col-span-8 space-y-16">
          {[
            ...
            <motion.div 
              key={pillar.id}
              className="flex flex-col sm:flex-row items-start space-y-4 sm:space-y-0 sm:space-x-8 border-b border-rosegold/10 pb-12 last:border-b-0"
            ...
            >
              <div className="flex items-center space-x-3 sm:flex-col sm:space-x-0 sm:space-y-2 shrink-0">
                <span className="text-rosegold font-serif font-semibold text-lg sm:text-2xl leading-none">
                  {pillar.id}
                </span>
                <div className="p-3 bg-burgundy/5 border border-rosegold/15 text-rosegold rounded-full">
        ...
        <div className="lg:col-span-4 lg:sticky lg:top-32 space-y-8">
          <div className="relative aspect-[3/4] border border-rosegold/20 overflow-hidden shadow-2xl">
            <Image 
          ...
          <div className="p-6 border border-rosegold/15 bg-burgundy/5 space-y-4 text-center font-sans text-xs">
            <span className="text-[9px] uppercase tracking-widest text-rosegold font-bold block">The Poise Pledge</span>
            <p className="text-pearl/60 leading-relaxed">
              &ldquo; poise changes how the world sees you. More importantly, it shifts how you look at yourself. Set your stance tall, align your center of gravity, and claim your presence.&rdquo;
            </p>
      ...
      <div className="luxury-container text-center pt-12">
        ...
        <p className="text-xs md:text-sm text-pearl/50 font-sans max-w-lg mx-auto mb-8 leading-relaxed">
