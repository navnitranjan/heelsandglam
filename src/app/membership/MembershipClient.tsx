        ...
        <div className="lg:col-span-7 flex flex-col space-y-8">
          ...
          <div className="space-y-6 pt-4 font-sans text-xs">
            {[
              ...
              { icon: Sparkles, title: "Monthly Poise Calibration", desc: "Interactive monthly alignment check sessions in Electronic City to review posture coordinates and walk biomechanics." },
