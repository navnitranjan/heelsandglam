...
export const metadata: Metadata = {
  title: 'Personality Development for Women | Executive Grace Academy',
...
export default function PersonalityDevelopmentPage() {
  const waMessage = encodeURIComponent(
    "Hi Aakanksha! I am exploring the Personality Development page and want to verify seat availability for the upcoming cohort."
  );
    ...
    <div className="min-h-screen bg-obsidian text-pearl py-12 md:py-24 relative overflow-hidden">
      ...
      <div className="luxury-container flex flex-col items-center text-center mb-16 md:mb-24 relative z-10">
        ...
        <p className="text-sm tracking-wide text-champagne max-w-xl leading-relaxed font-sans font-light">
          Develop an magnetic personality. Master verbal elegance, social etiquette, and executive carriage to command attention effortlessly.
        </p>
      </div>
      ...
      <section className="luxury-container grid grid-cols-1 lg:grid-cols-12 gap-16 items-center mb-20 relative z-10">
        ...
        <div className="lg:col-span-7 space-y-6">
          ...
          <h2 className="text-3xl md:text-5xl font-serif text-white leading-tight uppercase">Own the Boardroom & Ballroom</h2>
          <div className="w-12 h-[1px] bg-rosegold/40" />

          <p className="text-xs md:text-sm text-pearl/70 font-sans leading-relaxed">
            True elegance is a language spoken without words. Our personality development training focuses on aligning your physical stature, vocal resonance, and conversational grace, enabling you to present authority and approachability in perfect harmony.
          </p>
